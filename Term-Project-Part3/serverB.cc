...
#define FILE_PATH "dataB.csv"

const int SERVER_PORT = 42675;
...
int main() {
    // Now, 'students' vector contains the data from the CSV file
    // You can process and store it further as needed
